...
export type ThemeCategory =
  ...
  | 'Pastel' | 'Lofi' | 'Neon' | 'Food'

export type ThemeItem = {
  id: string
  category: ThemeCategory
  name: string
  dark?: boolean             // サイドバーをダークモードにするか（省略=false=ライト）
...
export const THEMES: ThemeItem[] = [
  ...
  { id: 'sky-2',  category: 'Sky', name: '惑星と星',  dark: true, ...p('sky/planet-stars.jpg') },
  ...
  { id: 'sky-10', category: 'Sky', name: '虹',        dark: true, ...p('sky/rainbow.jpg') },
  ...
  { id: 'night-2', category: 'Night', name: 'ハロウィン夜空', dark: true, ...p('night/halloween.jpg') },
  { id: 'night-3', category: 'Night', name: 'ネオンエネルギー', dark: true, ...p('night/neon-energy.jpg') },
  ...
  { id: 'illust-7',  category: 'Illustration', name: '魔法陣',             dark: true, ...p('illustration/magic-circle.jpg') },
  ...
  { id: 'illust-12', category: 'Illustration', name: '夏のイラスト',                   ...p('illustration/summer-illust.jpg') },
  { id: 'illust-13', category: 'Illustration', name: 'クジラファンタジー', dark: true, ...p('illustration/whale-fantasy.jpg') },
  { id: 'illust-14', category: 'Illustration', name: 'カラフルウェーブ',              ...p('illustration/colorful-wavy.jpg') },
  { id: 'illust-15', category: 'Illustration', name: 'AIアート・月',       dark: true, ...p('illustration/ai-pink-moon.jpg') },
  { id: 'illust-16', category: 'Illustration', name: '崖の猫',                        ...p('illustration/cat-cliff.jpg') },
  { id: 'illust-17', category: 'Illustration', name: '雪の結晶',                      ...p('illustration/snowflake.jpg') },
  { id: 'illust-18', category: 'Illustration', name: 'ビーチパーティー',   dark: true, ...p('illustration/beach-party.jpg') },
  { id: 'illust-19', category: 'Illustration', name: '赤いオープンカー',              ...p('illustration/red-car.jpg') },
  { id: 'illust-20', category: 'Illustration', name: '少女と夕焼け',       dark: true, ...p('illustration/girl-sunset.jpg') },
  { id: 'illust-21', category: 'Illustration', name: 'ラップトップ',                  ...p('illustration/laptop.jpg') },
  { id: 'illust-22', category: 'Illustration', name: 'カセットテープ',     dark: true, ...p('illustration/audio.jpg') },
  { id: 'illust-23', category: 'Illustration', name: 'ギター',                        ...p('illustration/guitar.png') },
  { id: 'illust-24', category: 'Illustration', name: 'タブレット男性',                ...p('illustration/man.png') },
  { id: 'illust-25', category: 'Illustration', name: 'カラフルスプラッシュ',          ...p('illustration/colorful-splash.jpg') },
  { id: 'illust-26', category: 'Illustration', name: '女性イラスト',                  ...p('illustration/woman.svg') },
  { id: 'illust-27', category: 'Illustration', name: '街',             dark: true,     ...p('illustration/city.jpg') },
  { id: 'illust-28', category: 'Illustration', name: 'サッカー',                      ...p('illustration/soccer.svg') },
  { id: 'illust-29', category: 'Illustration', name: '村',                            ...p('illustration/village.svg') },
  ...
  { id: 'food-2', category: 'Food', name: 'チーズ',                   ...p('food/cheese.png') },
...
// 各テーマの dark フラグで判定する（全67枚を個別に確認済み）
