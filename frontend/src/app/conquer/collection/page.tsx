...
export default function CollectionPage() {
  ...
  const { conquests, isLoading } = useConquerCollection()
      ...
      <div className="px-6 pt-8 pb-6">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl flex items-center justify-center shadow-md" style={{ background: 'linear-gradient(135deg, #d4af37, #b8960c)' }}>
